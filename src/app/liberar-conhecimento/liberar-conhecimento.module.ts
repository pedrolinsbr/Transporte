...
//  ##### ROUTES
import { LiberarConhecimentoRoutes    } from './liberar-conhecimento.routing';
...
@NgModule({
  imports: [
    CommonModule,
    RouterModule.forChild(LiberarConhecimentoRoutes),
    NgbModule.forRoot(),
...
export class LiberarConhecimentoModule {}
