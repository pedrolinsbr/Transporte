...
//  ##### ROUTES
import { MaloteRoutes } from './malote.routing';
...
import { AutofocusDirective } from './autocomplet.directive';

@NgModule({
  imports: [
    CommonModule,
    RouterModule.forChild(MaloteRoutes),
    NgbModule.forRoot(),
