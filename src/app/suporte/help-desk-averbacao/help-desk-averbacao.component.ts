...
@Component({
  selector: 'app-help-desk-averbacao',
  templateUrl: './help-desk-averbacao.component.html',
  styleUrls: ['./help-desk-averbacao.component.css']
})
export class HelpDeskAverbacaoComponent implements OnInit {
  apiService: any;
  closeResult: string;
  ...
  constructor(
    ...
    this.objFormVoid = formBuilder.group({
  ...
  indicadores = {
    url: this.apiUrl + "tp/averbacao/indicadores",
    cardsNum: [0, 1, 2]
  };
