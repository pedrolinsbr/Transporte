...
@Component({
  selector: 'app-ctrc-expedir',
  templateUrl: './ctrc-expedir.component.html',
  styleUrls: ['./ctrc-expedir.component.scss']
})
export class CtrcExpedirComponent implements OnInit {
  ...
  */
  ...
  constructor(
    ...
    public  cargaService   : CtrcExpedirService,
