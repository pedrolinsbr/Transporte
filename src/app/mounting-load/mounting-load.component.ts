...
export class MountingLoadComponent implements OnInit {
  ...
  @ViewChild('visaoQuatro') visaoQuatro : any;
  ...
  urlGrid = this.url + 'tp/documentoViagem/listarPendMotVei';

  totalizador  = {qtctrc:0, qtnfe:0, psbruto:0, vrmercad:0, pslotaca: 0};
  totalSeleci  = {qtctrc:0, qtnfe:0, psbruto:0, vrmercad:0, pslotaca: 0};
  lsDocumentos = {ctrc:{visaoUm:"", visaoDois:"", visaoTres:"", visaoQuatro:""}, delivery:{visaoUm:"", visaoDois:"", visaoTres:"", visaoQuatro:""}};
  objfunction  = {visaoUm:false, visaoDois:false, visaoTres:false, visaoQuatro:false};
  objStyle     = {
    'background' : '#43295b',
    'color'      : '#ffffff',
    'iconColor'  : '#ffffff',
  ...
  */
  ...
  constructor(
    ...
    this.objFormFilter = formBuilder.group({
      ...
      IDG024_CARGA      : [[], [Validators.required]], // ID TRANSPORTADORA CARGA
  ...
  ngOnInit() {
    ...
    // this.controlView = 6;
    this.totalizador = {qtctrc:0, qtnfe:0, psbruto:0, vrmercad:0, pslotaca: 0};
...
// Sugere um tipo de veiculo baseado no peso bruto da carga
  ...
  filtrar(flag = true){
    ...
    if(flag){
      this.objFormFilter.controls['lsDocumentos'].setValue({ctrc:{visaoUm:"", visaoDois:"", visaoTres:"", visaoQuatro:""}, delivery:{visaoUm:"", visaoDois:"", visaoTres:"", visaoQuatro:""}});
    }
    ...
    if(this.validaFormularioValido(this.objFormFilter)){
      ...
      this.getParametros({'parameter[IDG024]': this.objFormFilter.value.IDG024_CARGA.id});
    ...
    //  debugger;
      ...
      if(this.snCar4pl == 1){
        this.indicadores.url = this.urlIndicadores4pl    + this.objFormFilter.controls['IDG024_CARGA'].value.id;
        this.indicadores4pl.url = this.urlIndicadores4pl + this.objFormFilter.controls['IDG024_CARGA'].value.id;
      }else{
        this.indicadores.url = this.urlIndicadores       + this.objFormFilter.controls['IDG024_CARGA'].value.id;
        this.indicadores4pl.url = this.urlIndicadores4pl + this.objFormFilter.controls['IDG024_CARGA'].value.id;
      }
      ...
      switch(this.validOptionsView){
        ...
        case 'recebedor':
          ...
          this.detalharRecebedor();
          break;

        case 'CTRC':
          this.objfunction["visaoQuatro"] = false;
          this.detalharCtrc();
          break;
      }
  ...
  detalharCidade(){
    ...
    this.nameFuncDetail = 'detalharRecebedor';
  ...
  detalharRecebedor(){
    ...
    this.titleCard = "Visão por Recebedor";
    this.nameFuncDetail = 'detalharCtrc';
    // this.nameFuncBack = "detalharCidade";
    this.grid.findDataTable('detalhesRecebedor');
    document.querySelector('.main-content').scrollTop = 0;
    this.controlView = 3;
    if(!this.controlViewTable){
      this.set(5, "Recebedor", "detalharRecebedor", null, "fas fa-user");
    }
  }
  ...
  detalharCtrc(){
    ...
    this.controlView = 4;
    if(!this.controlViewTable){
      this.set(6, "CTRC", "detalharCtrc", null, "fas fa-file-alt");
    }
  }
  ...
  openCarga(){
    ...
    this.cargaService.buscaParadas({ doc: this.objFormFilter.controls['lsDocumentos'].value, cdo:this.objFormFilter.controls['IDG024_CARGA'].value.id}).subscribe(
      data=>{
        ...
        if(this.arGridCarga.length != 0){
          ...
          //this.objFormCarga.controls['SIMNAOOFERECE'].setValue('I');
          this.objFormCarga.controls['IDG003OR'].setValue({id: this.objFormFilter.controls['IDG024_CARGA'].value.idg003, text: this.objFormFilter.controls['IDG024_CARGA'].value.nmcidade + ' - '+ this.objFormFilter.controls['IDG024_CARGA'].value.cdestado});
          this.objFormCarga.controls['IDG003DE'].setValue({id: this.arGridCarga[this.arGridCarga.length - 1].IDG003DE, text: this.arGridCarga[this.arGridCarga.length - 1].NMCIDADE + ' - '+ this.arGridCarga[this.arGridCarga.length - 1].CDESTADE});
          
          //# Era necessário para validações com transportadora dados de carga etc.
          this.objFormCarga.controls['IDG024_CARGA'].setValue(this.objFormFilter.controls['IDG024_CARGA'].value);
  ...
  setPesoValorGeral(){
    ...
    this.getArmazemTranspCarga({'parameter[IDG024]': this.objFormFilter.value.IDG024_CARGA.id});
    //this.getParametros({'parameter[IDG024]': this.objFormFilter.value.IDG024_CARGA.id});
  ...
  loadDataGridFiles(){
    this.grid.findDataTable('idDataGridFiles','objFormCarga');
  }
  ...
  checkDocument() { // 1 - motorista 2- veiculo 3 - tipo veiculo 4 - cliente
  ...
  totalizadorGrid(){
    ...
    if(this.controlView == 1){
      ...
      visao = "visaoTres";
      visaoEach = 'input[type="hidden"][name^="obj_checkbox_detalhesRecebedor_"]';
    }else if(this.controlView == 4){
      visao = "visaoQuatro";
    ...
    for (var i = obj.length - 1; i >= 0; i--) {
      ...
      this.totalizador.pslotaca += obj[i].PSLOTACA;
    ...
    var lsDocumentosCteAux = {ctrc:{visaoUm:"", visaoDois:"", visaoTres:"", visaoQuatro:""}, delivery:{visaoUm:"", visaoDois:"", visaoTres:"", visaoQuatro:""}};
    var lsDocumentosNfeAux = {ctrc:{visaoUm:"", visaoDois:"", visaoTres:"", visaoQuatro:""}, delivery:{visaoUm:"", visaoDois:"", visaoTres:"", visaoQuatro:""}};
  ...
  totalSeleciGrid(){
    ...
    var that  = {qtctrc:0, qtnfe:0, psbruto:0, vrmercad:0, pslotaca: 0};

    lsDocumentosAux = {ctrc:{visaoUm:"", visaoDois:"", visaoTres:"", visaoQuatro:""}, delivery:{visaoUm:"", visaoDois:"", visaoTres:"", visaoQuatro:""}};
    ...
    if(this.controlView == 1){
      ...
      visao = 'input[type="hidden"][name^="obj_checkbox_detalhesRecebedor_"]';
      visaoControl = "visaoTres";
    }else if(this.controlView == 4){
      visao = 'input[type="hidden"][name^="obj_checkbox_detalhesCtrc_"]';
      visaoControl = "visaoQuatro";
    }
    ...
    this.cargaService.validaMontarCarga4PL(IDS001).subscribe(
      data=>{
          ...
          if(data.SNCAR4PL){
            ...
            this.objFormFilter.controls['IDT005'].setValue({id: 34 , text: 'SYNGENTA 4PL [34]'});
  ...
  alteraTranspCarga(event){
    console.log("oi", event,this.objFormFilter.controls['IDG024'].value);
    if(this.objFormFilter.controls['IDG024'].value.length == 1){
      this.objFormFilter.controls['IDG024_CARGA'].setValue(this.objFormFilter.controls['IDG024'].value[0])
    }else{
      this.objFormFilter.controls['IDG024_CARGA'].setValue(null);
    }
  }
