...
@Injectable()
export class MontarCargaService {
 ...
 buscarMontarCarga(obj){return this.http.post<any>(this.url + "tp/montagemCarga/listar", obj ) };
 cancelarDeliveries(obj){return this.http.post<any>(this.url + "tp/montagemCarga/excluir", obj ) };


 salvarMontarCarga(obj){return this.http.post<any>(this.url + "tp/montagemCarga/salvar", obj) };

 salvarReprocessarCarga(obj){return this.http.post<any>(this.url + "tp/montagemCarga/reprocessar", obj) };
 ...
 SalvarCarga(obj) { return this.http.post<any>(this.url + "hc/agendamento/salvar", obj) };
 ...
 buscarCargas(obj){return this.http.post<any>(this.url + "hc/agendamento/buscar/agendamentos", obj ) };
 ...
 editarCarga(obj){return this.http.post<any>(this.url + "hc/agendamento/editar-agendamento", obj ) };
